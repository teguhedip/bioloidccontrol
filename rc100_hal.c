...
int rc100_hal_get_qstate(void);
void rc100_hal_put_queue( unsigned char data );
unsigned char rc100_hal_get_queue(void);

SIGNAL(USART1_RX_vect)
{
	rc100_hal_put_queue( UDR1 );
}
...
void rc100_hal_put_queue( unsigned char data )
{
	if( rc100_hal_get_qstate() == (MAXNUM_ZGBBUFF-1) )
		return;
